...
-- -----------------------------------------------------
-- Table `workwear`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`users` (
...
-- -----------------------------------------------------
-- Table `workwear`.`base_parameters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`base_parameters` (
...
-- -----------------------------------------------------
-- Table `workwear`.`objects`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`objects` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `workwear`.`posts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`posts` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `workwear`.`leaders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`leaders` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `workwear`.`item_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`item_types` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `workwear`.`units`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`units` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `workwear`.`nomenclature`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`nomenclature` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_nomenclature_units_idx` (`units_id` ASC),
  CONSTRAINT `fk_nomenclature_type`
    FOREIGN KEY (`type_id`)
    REFERENCES `workwear`.`item_types` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_nomenclature_units`
    FOREIGN KEY (`units_id`)
    REFERENCES `workwear`.`units` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 1
...
-- -----------------------------------------------------
-- Table `workwear`.`wear_cards`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`wear_cards` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_wear_cards_object`
    ...
    REFERENCES `workwear`.`objects` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_wear_cards_post`
    FOREIGN KEY (`post_id`)
    REFERENCES `workwear`.`posts` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_wear_cards_leader`
    FOREIGN KEY (`leader_id`)
    REFERENCES `workwear`.`leaders` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_wear_cards_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `workwear`.`users` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `workwear`.`stock_income`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`stock_income` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `workwear`.`stock_expense`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`stock_expense` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `workwear`.`object_places`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`object_places` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `workwear`.`stock_expense_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`stock_expense_detail` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `workwear`.`stock_income_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`stock_income_detail` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_stock_income_detail_stock_income`
    ...
    REFERENCES `workwear`.`stock_income` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_stock_income_detail_stock_expense`
    ...
    REFERENCES `workwear`.`stock_expense_detail` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 1
...
-- -----------------------------------------------------
-- Table `workwear`.`stock_write_off`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`stock_write_off` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `date` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `workwear`.`stock_write_off_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workwear`.`stock_write_off_detail` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_stock_write_off_detail_write_off`
    ...
    REFERENCES `workwear`.`stock_write_off` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Data for table `workwear`.`base_parameters`
-- -----------------------------------------------------
START TRANSACTION;
USE `workwear`;
INSERT INTO `workwear`.`base_parameters` (`name`, `str_value`) VALUES ('product_name', 'workwear');
INSERT INTO `workwear`.`base_parameters` (`name`, `str_value`) VALUES ('version', '1.0');
INSERT INTO `workwear`.`base_parameters` (`name`, `str_value`) VALUES ('edition', 'gpl');
INSERT INTO `workwear`.`base_parameters` (`name`, `str_value`) VALUES ('serial_number', NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `workwear`.`units`
-- -----------------------------------------------------
START TRANSACTION;
USE `workwear`;
INSERT INTO `workwear`.`units` (`id`, `name`) VALUES (NULL, 'пара');
INSERT INTO `workwear`.`units` (`id`, `name`) VALUES (NULL, 'шт.');
