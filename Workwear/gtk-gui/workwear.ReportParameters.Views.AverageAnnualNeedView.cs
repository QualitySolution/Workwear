...
namespace workwear.ReportParameters.Views
{
	public partial class AverageAnnualNeedView
	{
		...
		private global::Workwear.ReportParameters.Views.ChoiceEmployeeGroupView choiceemployeegroupview4;
		...
		protected virtual void Build()
		{
			...
			this.ycheckShowSize.Label = global::Mono.Unix.Catalog.GetString("Детализировать по размеру");
			...
			this.choiceemployeegroupview4.Name = "choiceemployeegroupview4";
			this.expander1.Add(this.choiceemployeegroupview4);
			this.GtkLabel7 = new global::Gtk.Label();
			this.GtkLabel7.Name = "GtkLabel7";
			this.GtkLabel7.LabelProp = global::Mono.Unix.Catalog.GetString("Группы сотрудников");
			this.GtkLabel7.UseUnderline = true;
			this.expander1.LabelWidget = this.GtkLabel7;
			this.dialog1_VBox.Add(this.expander1);
			global::Gtk.Box.BoxChild w10 = ((global::Gtk.Box.BoxChild)(this.dialog1_VBox[this.expander1]));
			w10.Position = 1;
			// Container child dialog1_VBox.Gtk.Box+BoxChild
