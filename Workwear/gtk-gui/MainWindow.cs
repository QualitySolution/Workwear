...
public partial class MainWindow
{
	...
	private global::Gtk.Action ActionSize;
	...
	private global::Gtk.Action ActionServices;

	private global::Gtk.Action ActionMenuNotification;

	private global::Gtk.Action ActionMenuClaims;

	private global::Gtk.Action ActionMenuRatings;

	private global::Gtk.Action ActionOwner;

	private global::Gtk.Action ActionBarcodes;
	...
	private global::Gtk.Action ActionPostomatDocs;

	private global::Gtk.Action ActionClothingService;

	private global::Gtk.Action ActionDutyNorm;

	private global::Gtk.Action ActionProvision;

	private global::Gtk.Action ActionExport;
	...
	private global::Gtk.Action ActionCausesWriteOff;
	...
	protected virtual void Build()
	{
		...
		this.Action46 = new global::Gtk.Action("Action46", global::Mono.Unix.Catalog.GetString("База"), null, null);
		this.Action46.ShortLabel = global::Mono.Unix.Catalog.GetString("База");
		w1.Add(this.Action46, null);
		this.Action47 = new global::Gtk.Action("Action47", global::Mono.Unix.Catalog.GetString("Справочники"), null, null);
		this.Action47.ShortLabel = global::Mono.Unix.Catalog.GetString("Справочники");
		...
		this.Action42 = new global::Gtk.Action("Action42", global::Mono.Unix.Catalog.GetString("Типы номенклатуры"), null, null);
		this.Action42.ShortLabel = global::Mono.Unix.Catalog.GetString("Типы номенклатуры");
		...
		this.ActionHistoryLog = new global::Gtk.Action("ActionHistoryLog", global::Mono.Unix.Catalog.GetString("История изменений"), null, "logs");
		this.ActionHistoryLog.ShortLabel = global::Mono.Unix.Catalog.GetString("История изменений");
		w1.Add(this.ActionHistoryLog, null);
		this.ActionSize = new global::Gtk.Action("ActionSize", global::Mono.Unix.Catalog.GetString("Размеры"), null, null);
		this.ActionSize.HideIfEmpty = false;
		this.ActionSize.ShortLabel = global::Mono.Unix.Catalog.GetString("Размеры");
		w1.Add(this.ActionSize, null);
		this.ActionSizeType = new global::Gtk.Action("ActionSizeType", global::Mono.Unix.Catalog.GetString("Типы размеров"), null, null);
		...
		this.ActionServices = new global::Gtk.Action("ActionServices", global::Mono.Unix.Catalog.GetString("Сервисы"), null, null);
		this.ActionServices.ShortLabel = global::Mono.Unix.Catalog.GetString("Сервисы");
		w1.Add(this.ActionServices, null);
		this.ActionMenuNotification = new global::Gtk.Action("ActionMenuNotification", global::Mono.Unix.Catalog.GetString("Уведомление сотрудников"), null, "mail");
		this.ActionMenuNotification.ShortLabel = global::Mono.Unix.Catalog.GetString("Уведомление сотрудников");
		w1.Add(this.ActionMenuNotification, null);
		this.ActionMenuClaims = new global::Gtk.Action("ActionMenuClaims", global::Mono.Unix.Catalog.GetString("Обращения сотрудников"), null, " SendBox");
		this.ActionMenuClaims.ShortLabel = global::Mono.Unix.Catalog.GetString("Обращения");
		w1.Add(this.ActionMenuClaims, null);
		this.ActionMenuRatings = new global::Gtk.Action("ActionMenuRatings", global::Mono.Unix.Catalog.GetString("Отзывы на продукцию"), null, "gtk-about");
		this.ActionMenuRatings.ShortLabel = global::Mono.Unix.Catalog.GetString("Отзывы");
		w1.Add(this.ActionMenuRatings, null);
		...
		w1.Add(this.ActionClothingService, null);
		this.ActionDutyNorm = new global::Gtk.Action("ActionDutyNorm", global::Mono.Unix.Catalog.GetString("Дежурные нормы"), null, null);
		this.ActionDutyNorm.ShortLabel = global::Mono.Unix.Catalog.GetString("Дежурные нормы");
		w1.Add(this.ActionDutyNorm, null);
		...
		this.ActionCausesWriteOff = new global::Gtk.Action("ActionCausesWriteOff", global::Mono.Unix.Catalog.GetString("Причины списания"), null, null);
		this.ActionCausesWriteOff.ShortLabel = global::Mono.Unix.Catalog.GetString("Причины списания");
		w1.Add(this.ActionCausesWriteOff, null);
		...
		this.UIManager.AddUiFromString("<ui><menubar name=\'menubar1\'><menu name=\'Action46\' action=\'Action46\'><menuitem na" +
				"me=\'UsersAction\' action=\'UsersAction\'/><menuitem name=\'dialogAuthenticationActio" +
				"n\' action=\'dialogAuthenticationAction\'/><menuitem name=\'ActionUserSettings\' acti" +
				"on=\'ActionUserSettings\'/><separator/><menuitem name=\'ActionBaseSettings\' action=" +
				"\'ActionBaseSettings\'/><menu name=\'ActionImport\' action=\'ActionImport\'><menuitem " +
				"name=\'ActionEmployeeLoad\' action=\'ActionEmployeeLoad\'/><menuitem name=\'ActionNor" +
				"msLoad\' action=\'ActionNormsLoad\'/><menuitem name=\'ActionImportWorkwearItems\' act" +
				"ion=\'ActionImportWorkwearItems\'/><separator/><menuitem name=\'ActionIncomeLoad\' a" +
				"ction=\'ActionIncomeLoad\'/></menu><menu name=\'ActionExport\' action=\'ActionExport\'" +
				"><menuitem name=\'Action40\' action=\'Action40\'/></menu><menu name=\'ActionBatchProc" +
				"essing\' action=\'ActionBatchProcessing\'><menuitem name=\'ActionProcessingEmployee\'" +
				" action=\'ActionProcessingEmployee\'/><menuitem name=\'ActionReplaceEntity\' action=" +
				"\'ActionReplaceEntity\'/></menu><menuitem name=\'ActionHistoryLog\' action=\'ActionHi" +
				"storyLog\'/><separator/><menuitem name=\'quitAction\' action=\'quitAction\'/></menu><" +
				...
				"<menuitem name=\'ActionMaxizizeOnStart\' action=\'ActionMaxizizeOnStart\'/></menu><m" +
				"enu name=\'Action21\' action=\'Action21\'><menuitem name=\'ActionStockDocs\' action=\'A" +
				"ctionStockDocs\'/><menuitem name=\'ActionStockBalance\' action=\'ActionStockBalance\'" +
				"/><menuitem name=\'ActionStockMovements\' action=\'ActionStockMovements\'/><separato" +
				"r/><menuitem name=\'ActionWarehouseForecasting\' action=\'ActionWarehouseForecastin" +
				"g\'/><menuitem name=\'ActionIssuanceRequest\' action=\'ActionIssuanceRequest\'/><menu" +
				"item name=\'ActionShipment\' action=\'ActionShipment\'/><separator/><menuitem name=\'" +
				"ActionClothingService\' action=\'ActionClothingService\'/><menuitem name=\'ActionVis" +
				"its\' action=\'ActionVisits\'/><menuitem name=\'ActionIssuanceSheets\' action=\'Action" +
				"IssuanceSheets\'/></menu><menu name=\'ActionServices\' action=\'ActionServices\'><men" +
				"uitem name=\'ActionMenuNotification\' action=\'ActionMenuNotification\'/><menuitem n" +
				"ame=\'ActionMenuClaims\' action=\'ActionMenuClaims\'/><menuitem name=\'ActionMenuRati" +
				"ngs\' action=\'ActionMenuRatings\'/><menuitem name=\'ActionSpecCoinsBalance\' action=" +
				"\'ActionSpecCoinsBalance\'/><separator/><menuitem name=\'ActionFullnessPostomats\' a" +
				"ction=\'ActionFullnessPostomats\'/><menuitem name=\'ActionPostomatDocs\' action=\'Act" +
				"ionPostomatDocs\'/><menuitem name=\'ActionPostomatDocsWithdraw\' action=\'ActionPost" +
				"omatDocsWithdraw\'/></menu><menu name=\'Action47\' action=\'Action47\'><menuitem name" +
				"=\'ActionOrganizations\' action=\'ActionOrganizations\'/><menuitem name=\'ActionObjec" +
				...
				"Norms\' action=\'ActionNorms\'/><menuitem name=\'ActionConditionNorm\' action=\'Action" +
				"ConditionNorm\'/><menuitem name=\'ActionDutyNorm\' action=\'ActionDutyNorm\'/><menuit" +
				"em name=\'ActionCausesWriteOff\' action=\'ActionCausesWriteOff\'/><menuitem name=\'Ac" +
				"tionCausesIssue\' action=\'ActionCausesIssue\'/><separator/><menuitem name=\'Action4" +
				"3\' action=\'Action43\'/><menuitem name=\'Action42\' action=\'Action42\'/><menuitem nam" +
				"e=\'Action6\' action=\'Action6\'/><menuitem name=\'ActionWarehouse\' action=\'ActionWar" +
				"ehouse\'/><menuitem name=\'ActionOwner\' action=\'ActionOwner\'/><menuitem name=\'Acti" +
				"onClothingServices\' action=\'ActionClothingServices\'/><menuitem name=\'ActionBarco" +
				"des\' action=\'ActionBarcodes\'/><separator/><menuitem name=\'ActionSizeType\' action" +
				"=\'ActionSizeType\'/><menuitem name=\'ActionSize\' action=\'ActionSize\'/><separator/>" +
				"<menuitem name=\'Action7\' action=\'Action7\'/><menuitem name=\'ActionNotificationTem" +
				"plates\' action=\'ActionNotificationTemplates\'/><separator/><menuitem name=\'Action" +
				"Profession\' action=\'ActionProfession\'/><menuitem name=\'Action8\' action=\'Action8\'" +
				"/><menuitem name=\'ActionVacationTypes\' action=\'ActionVacationTypes\'/><menuitem n" +
				"ame=\'ActionCostCenter\' action=\'ActionCostCenter\'/><menuitem name=\'ActionLeaders\'" +
				" action=\'ActionLeaders\'/></menu><menu name=\'ActionReports\' action=\'ActionReports" +
				"\'><menuitem name=\'Action11\' action=\'Action11\'/><menuitem name=\'ActionStockOperat" +
				"ions\' action=\'ActionStockOperations\'/><separator/><menuitem name=\'Action10\' acti" +
				"on=\'Action10\'/><menuitem name=\'Action12\' action=\'Action12\'/><menuitem name=\'Issu" +
				"eSizeReport\' action=\'IssueSizeReport\'/><separator/><menuitem name=\'ActionAmountI" +
				"ssuedWear\' action=\'ActionAmountIssuedWear\'/><menuitem name=\'ActionWriteOffAct\' a" +
				"ction=\'ActionWriteOffAct\'/><menuitem name=\'ActionClothingServiceReport\' action=\'" +
				"ActionClothingServiceReport\'/><separator/><menuitem name=\'ActionRequestSheet\' ac" +
				"tion=\'ActionRequestSheet\'/><menuitem name=\'ActionShipmentReport\' action=\'ActionS" +
				"hipmentReport\'/><menuitem name=\'ActionAverageAnnualNeed\' action=\'ActionAverageAn" +
				"nualNeed\'/><menu name=\'Action\' action=\'Action\'><menuitem name=\'ActionNotIssuedSh" +
				"eetDetail\' action=\'ActionNotIssuedSheetDetail\'/><menuitem name=\'ActionNotIssuedS" +
				"heetSummary\' action=\'ActionNotIssuedSheetSummary\'/></menu><separator/><menuitem " +
				"name=\'ActionWearCardsReport\' action=\'ActionWearCardsReport\'/><menuitem name=\'Act" +
				"ionAmountEmployeeGetWear\' action=\'ActionAmountEmployeeGetWear\'/><menuitem name=\'" +
				"ActionProvision\' action=\'ActionProvision\'/><menuitem name=\'ActionBarcodeComplete" +
				"nessReport\' action=\'ActionBarcodeCompletenessReport\'/><menu name=\'ActionDutyNorm" +
				"Reports\' action=\'ActionDutyNormReports\'><menuitem name=\'ActionDutyNormIssuedRepo" +
				...
				"ate\' action=\'ActionOffAutoUpdate\'/></menu><menuitem name=\'ActionUpdate\' action=\'" +
				"ActionUpdate\'/><separator/><menuitem name=\'ActionSite\' action=\'ActionSite\'/><men" +
				"u name=\'Action48\' action=\'Action48\'><menuitem name=\'TelegramAction\' action=\'Tele" +
				"gramAction\'/><menuitem name=\'MAXAction\' action=\'MAXAction\'/><menuitem name=\'Emai" +
				"lAction\' action=\'EmailAction\'/></menu><separator/><menuitem name=\'ActionSN\' acti" +
				"on=\'ActionSN\'/><separator/><menuitem name=\'aboutAction\' action=\'aboutAction\'/></" +
				"menu></menubar></ui>");
		...
		this.Action42.Activated += new global::System.EventHandler(this.OnAction5Activated);
		...
		this.ActionMenuNotification.Activated += new global::System.EventHandler(this.OnActionMenuNotificationActivated);
		...
		this.ActionPostomatDocs.Activated += new global::System.EventHandler(this.OnActionPostomatDocsActivated);
		this.ActionClothingService.Activated += new global::System.EventHandler(this.OnActionClothingServiceActivated);
		this.ActionDutyNorm.Activated += new global::System.EventHandler(this.OnActionDutyNormActivated);
		this.ActionProvision.Activated += new global::System.EventHandler(this.OnActionProvisionActivated);
		this.Action40.Activated += new global::System.EventHandler(this.OnFutureIssueActionActivated);
		...
		this.ActionCausesWriteOff.Activated += new global::System.EventHandler(this.OnActionCausesWriteOffActivated);
