...
{
	public partial class IssuanceSheetM52View : ViewBase<IssuanceSheetM52ViewModel>
	{
		public IssuanceSheetM52View(IssuanceSheetM52ViewModel viewModel) : base(viewModel)
		{
			this.Build();
