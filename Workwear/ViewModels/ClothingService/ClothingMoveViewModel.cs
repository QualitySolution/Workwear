		...
		private OutgoingMessage MakeNotificationMessage(ClaimState claimState, string nomenclatureName, string phone)
		{
			...
			switch (claimState)
			{
				...
				case ClaimState.InRepair:
					text = $"Ваша спецодежда {nomenclatureName} перемещена в ремонт. \n Уважаемые сотрудники! По техническим причинам срок ремонта спецодежды увеличивается до 7 рабочих дней. Просим учесть данные сроки при сдаче вещей на обслуживание.";
					break;
