...
namespace Workwear.Views.Stock {
	...
	public partial class ProcurementView : EntityDialogViewBase<ProcurementViewModel, Procurement> {
		public ProcurementView(ProcurementViewModel viewModel) : base(viewModel) {
			this.Build();
			ConfigureDlg();
			ConfigureItems();
		...
		private void ConfigureItems() {
			ytreeItems.ColumnsConfig = Gamma.GtkWidgets.ColumnsConfigFactory.Create<ProcurementItem>()
				.AddColumn("Ном. №")
		...
		private void ytreeItems_Selection_Changed(object sender, EventArgs e) {
			ViewModel.SelectedItem = ytreeItems.GetSelectedObject<ProcurementItem>();
		}
		protected void OnYbuttonAddClicked(object sender, EventArgs e) {
			ViewModel.AddItem();
		}
		protected void OnYbuttonDelClicked(object sender, EventArgs e) {
			ViewModel.DeleteItem(ytreeItems.GetSelectedObject<ProcurementItem>());
		}
	}
}
