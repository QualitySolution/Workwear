...
namespace workwear.Views.Stock
{
	...
	public partial class WarehouseMassExpenseView : EntityDialogViewBase<WarehouseMassExpenseViewModel, MassExpense>
	{
		...
		private void ConfigureDlg()
		{
			...
			.AddColumn("Размер").Tag(СlothesType.Wear).AddComboRenderer(x => x.WearSize)
			...
			.AddColumn("Размер обуви").Tag(СlothesType.Shoes).AddComboRenderer(x => x.ShoesSize)
			...
			.AddColumn("Размер зимней обуви").Tag(СlothesType.WinterShoes).AddComboRenderer(x => x.WinterShoesSize)
			...
			.AddColumn("Размер головного убора").Tag(СlothesType.Headgear).AddComboRenderer(x => x.HeaddressSize)
			...
			.AddColumn("Размер перчаток").Tag(СlothesType.Gloves).AddComboRenderer(x => x.GlovesSize)
