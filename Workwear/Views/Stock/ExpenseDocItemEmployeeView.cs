...
namespace workwear.Views.Stock
{
	...
	public partial class ExpenseDocItemEmployeeView : Gtk.Bin
	{
		...
		public void Configure()
		{
			...
			if(ViewModel.expenseEmployeeViewModel.Entity.Operation == ExpenseOperations.Object)
				ExpenseDoc_PropertyChanged(ViewModel.expenseEmployeeViewModel.Entity, new System.ComponentModel.PropertyChangedEventArgs(ViewModel.expenseEmployeeViewModel.Entity.GetPropertyName(x => x.Subdivision)));
