	...
	public class ScriptsConfiguration
	{
		...
		public static UpdateConfiguration MakeUpdateConfiguration()
		{
			...
			configuration.AddUpdate(
				new Version(2, 8, 13),
				new Version(2, 8, 14),
				"Workwear.Sql.Scripts.2.8.14.sql"
			);
			configuration.AddUpdate(
				new Version(2, 8, 14),
				new Version(2, 8, 15),
			...
			configuration.AddUpdate(
				new Version(2, 8, 33),
				new Version(2, 8, 35),
				"Workwear.Sql.Scripts.2.8.35.sql"
			);
			configuration.AddUpdate(
				new Version(2, 8, 35),
				new Version(2, 8, 36),
			...
			configuration.AddUpdate(
				new Version(2, 10, 6),
				new Version(2, 10, 7),
				"Workwear.Sql.Scripts.2.10.7.sql"
			);
			configuration.AddUpdate(
				new Version(2, 10, 7),
				new Version(2, 10, 8),
				"Workwear.Sql.Scripts.2.10.8.sql"
			);
			configuration.AddUpdate(
            	new Version(2, 10, 8),
            	new Version(2, 10, 9),
            	"Workwear.Sql.Scripts.2.10.9.sql"
            );
			configuration.AddUpdate(
				new Version(2, 10, 9),
				new Version(2, 10, 11),
			...
			configuration.AddUpdate(
				new Version(2, 10, 12),
				new Version(2, 10, 13),
				"Workwear.Sql.Scripts.2.10.13.sql"
			);
