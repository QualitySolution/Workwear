...
(
	...
	constraint fk_duty_norms_regulations
		foreign key (regulations_id) references regulations (id)
			on update cascade,
	constraint fk_duty_norms_annex
		foreign key (regulations_annex_id) references regulations_annex (id)
			on update cascade
);
...
(
	...
	period_type         enum ('Year', 'Month', 'Shift', 'Wearout') default 'Year' not null,
	period_count        tinyint unsigned                                   default 1      not null,
	next_issue			date 															  null,
	norm_paragraph      varchar(200)                                                      null,
	comment             text                                                              null,
...
INSERT INTO `base_parameters` (`name`, `str_value`) VALUES ('version', '2.9');
