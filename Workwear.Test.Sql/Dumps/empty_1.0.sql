...
INSERT INTO `base_parameters` (`name`, `str_value`) VALUES ('version', '1.0');
INSERT INTO `base_parameters` (`name`, `str_value`) VALUES ('edition', 'gpl');
INSERT INTO `base_parameters` (`name`, `str_value`) VALUES ('serial_number', NULL);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `units` (`id`, `name`) VALUES (NULL, 'пара');
INSERT INTO `units` (`id`, `name`) VALUES (NULL, 'шт.');
