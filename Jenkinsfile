...
node {
   ...
   stage('QSProjects') {
      checkout([$class: 'GitSCM', branches: [[name: '*/feature/VersionRefactory']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: 'QSProjects']], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/QualitySolution/QSProjects.git']]])
