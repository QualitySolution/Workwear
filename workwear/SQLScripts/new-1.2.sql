...
CREATE TABLE IF NOT EXISTS `item_types` (
  ...
  `wear_category` ENUM('Wear','Shoes','Headgear','Gloves') NULL DEFAULT NULL,
...
-- Table `wear_cards`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wear_cards` ;
...
CREATE TABLE IF NOT EXISTS `wear_cards` (
  ...
  `wear_growth` VARCHAR(5) NULL DEFAULT NULL,
...
-- Table `stock_expense`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `stock_expense` ;
...
-- Table `object_places`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `object_places` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `stock_expense_detail` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `stock_income_detail` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `stock_write_off_detail` ;
...
-- Table `norms_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `norms_item` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `norms_professions` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wear_cards_norms` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wear_cards_item` ;
...
INSERT INTO `base_parameters` (`name`, `str_value`) VALUES ('version', '1.2');
